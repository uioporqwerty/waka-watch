...
params = {
    'api-version': '3.0',
    'from': 'en',
    'to': ['fr', 'es', 'hi', 'de', 'ja', 'pt-pt', 'ru', 'zh-Hant', 'tr', 'uk', 'th', 'it', 'sv', 'pl', 'fi', 'sk', 'ko', 'vi', 'ro', 'el', 'hu', 'nl', 'id']
}
...
with open(f"{working_directory}/wakawatch/fastlane/metadata/en-US/release_notes.txt", 'r') as file:
    ...
    with open(f"{working_directory}/wakawatch/wakawatch WatchKit Extension/Content/en.lproj/WhatsNew.txt", "r+") as whats_new:
            whats_new.write(release_notes)