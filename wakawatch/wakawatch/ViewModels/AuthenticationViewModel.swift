...
final class AuthenticationViewModel {
    ...
    private let githubAuthenticationService: GithubAuthenticationService
    ...
    public let githubAuthorizationUrl: URL
    ...
    init(authenticationService: AuthenticationService,
        ...
        self.githubAuthorizationUrl = self.githubAuthenticationService.authorizationUrl
    ...
    func isValidGithubState(stateCode: String) -> Bool {
        return self.githubAuthenticationService.isValidState(stateCode)
    }
    
    func authenticateGithub(authorizationCode: String) async {
        Task {
            do {
                let accessTokenResponse = try await githubAuthenticationService
                                                    .getAccessToken(authorizationCode: authorizationCode)
